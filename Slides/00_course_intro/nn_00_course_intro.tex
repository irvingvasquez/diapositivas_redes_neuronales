...
\title{
	%\includegraphics[width=2cm]{cidetec}\hspace*{4.75cm} %\includegraphics[width=2cm]{logo_conacyt}\hspace*{4.75cm} 
...
%{ 	\usebackgroundtemplate{\includegraphics[width=1.0\paperwidth]{fondo}}%
\frame{\titlepage} 
%}
