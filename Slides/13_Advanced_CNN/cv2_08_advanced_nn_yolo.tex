...
\title{
	%\includegraphics[width=3cm]{logo_conacyt}\hspace*{4.75cm} %\includegraphics[width=1.8cm]{cidetec}\hspace*{4.75cm} 
...
{\usebackgroundtemplate{\includegraphics[width=1.0\paperwidth]{position}}%
\begin{frame}
\frametitle{Object detection}
...
{\usebackgroundtemplate{\includegraphics[width=1.0\paperwidth]{rcnn}}%
\begin{frame}
\frametitle{R-CNN}
...
{\usebackgroundtemplate{\includegraphics[width=1.0\paperwidth]{background}}%
\begin{frame}
